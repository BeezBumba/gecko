...
fn main() {
    ...
    chipi::generate("../rsrc/chipi-spec/gamecube/gekko.chipi", out_dir.join("gekko.rs").to_str().unwrap())
    ...
    chipi::generate("../rsrc/chipi-spec/gamecube/dsp.chipi", out_dir.join("dsp.rs").to_str().unwrap())
