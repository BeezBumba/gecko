...
pub fn ps_ops<const OP: u32>(ctx: &mut crate::gekko::Gekko, instr: crate::cpu::semantics::Instruction) {
    match OP {
...
#[inline(always)]
fn ps_write(ctx: &mut crate::gekko::Gekko, instr: &crate::cpu::semantics::Instruction, ps0: f64, ps1: f64) {
